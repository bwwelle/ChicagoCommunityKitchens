...
public partial class LabelReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        m_SQL = "DECLARE @CreatedMeal varchar(50) EXEC spInsertLabelInformationBreakfast '" + reportStartDate + "', @CreatedMeal = @CreatedMeal OUTPUT SELECT @CreatedMeal as 'CreatedMeal'"; ;
