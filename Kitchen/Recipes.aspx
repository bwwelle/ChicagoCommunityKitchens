<%@ Page Language="VB" Title = "CCK Recipes" EnableEventValidation="false" AutoEventWireup="false"  MasterPageFile="~/Site.master" CodeFile="Recipes.aspx.vb" Inherits="Recipes" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div align="left">
        <asp:Label ID="Label1" runat="server" Text="View Recipes"></asp:Label>&nbsp;</div>
        <table style="width: 100%">
            ...
            <tr>
                <td align="right" colspan="13" class="style1">
                    <asp:TextBox ID="RecipeNameSearchTextBox" runat="server" Width="279px"></asp:TextBox>
                </td>
                <td align="left" colspan="13" class="style1">
                    <asp:Button ID="RecipeSearchButton" runat="server" Text="Search" Width="106px" 
                        Font-Bold="True" style="margin-bottom: 0px"/>
                </td>
            </tr>
            <tr>
                <td align="center" colspan="26" style="height: 26px">
                    <asp:Button ID="CreateNewRecipeButton" runat="server" Text="Create New Recipe" /></td>
            </tr>
            <tr>
                <td align="center" colspan="26" style="height: 22px">
                    <asp:GridView ID="RecipeGridView" runat="server" OnRowDataBound="RecipeGridView_RowDataBound" OnSelectedIndexChanging="RecipeGridView_SelectedIndexChanging">
