<%@ Page Language="C#" Title="CCK Meal Planner" MasterPageFile="~/Site.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="MealCalendar.aspx.cs" Inherits="MealCalendar" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        function fnOpenMealDetail(sender, e) {
            $find("mpeModalPopupBehavior").show();
        }
        ...
        function pageLoad() {
            ...
            if (launchCookChill) {
                $find("CookChillPopupBehavior").show();
            }
        }     
    </script>
        ...
        function updatecookchillyield() {
            ...
            if (ccb != "" && ccd != "") {
                ...
                if (ccg == OriginalYield) {
                    ...
                    document.form1.elements['CookChillConversionFactorTextBox'].value = roundNumber(ConversionFactor, 2);
                }
            }
            else {
                document.form1.elements['CookChillConversionFactorTextBox'].value = 'N/A';
        ...
        function updateregularyield() {
            ...
            if (document.form1.elements['RecipeNumberofServings'].value != "") {
                ...
                if (RecipeYield == OriginalYield) {
                    ...
                    document.form1.elements['ConversionFactorTextBox'].value = roundNumber(ConversionFactor, 2);
                }
            }
            else {
                document.form1.elements['ConversionFactorTextBox'].value = 'N/A';
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="CalendarPanel" runat="server" Width="100%">
        ...
        <tr style="width: 100%; border-style: none solid solid solid; border-width: thin;
            ...
            <td colspan="4" valign="top" style="border-style: none solid solid solid; border-width: thin;
                border-color: #FFFFFF;">
                <asp:Calendar ID="DeliveryCalendarControl" runat="server" Width="100%" OnDayRender="MenuDeliveryCalendarControl_DayRender" OnSelectionChanged="CalendarDateClick"
                    OnVisibleMonthChanged="MenuDeliveryCalendarControl_VisibleMonthChanged" FirstDayOfWeek="Sunday"
                    ...
                    <OtherMonthDayStyle BackColor="#E0E0E0" ForeColor="Black" Font-Bold="True" />
                    <TitleStyle Font-Bold="True" ForeColor="#004D45" CssClass="_title"/>
    ...
    <asp:Panel ID="MenuComponentsPanel" runat="server" BackColor="#00C7B3" Width="900px"
        CssClass="modalBackground" ForeColor="Black">
        <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <table style="width: 899px">
                    ...
                    <tr>
                        <td align="right" style="height: 11px; width: 446px;" valign="bottom">
                            <asp:Label ID="MenuDayLabelLabel" runat="server" Font-Bold="True" Text="Date of Meal:"
                    ...
                    <tr>
                        <td align="right" valign="bottom" style="width: 446px; height: 11px">
                            <asp:Label ID="TotalMealCountLabel" runat="server" Font-Bold="True" Text="Total Regular Meal Count For This Date:"></asp:Label>
                        </td>
                        <td align="left" style="width: 50%; height: 18px;" valign="bottom">
                    ...
                    <tr>
                        <td align="center" colspan="2" style="height: 11px" valign="bottom">
                            ...
                            <asp:Button ID="Button2" ControlID="Button2" runat="server" Text="<-" OnClick="Button2_Click"
                                Width="25px" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="width: 50%; height: 15px" valign="bottom">
                            <div id="lstSelectDiv" style="overflow: auto; width: 85%; height: 86px">
                                <asp:ListBox ID="lstSelect" runat="server" AppendDataBoundItems="True" SelectionMode="Multiple">
                                </asp:ListBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" class="style3" valign="bottom">
                            Site(s) Above <b>Will Not</b> Receive This Meal
                        </td>
                        <td align="center" class="style4" valign="bottom">
                            Site(s) Above <b>Will</b> Receive This Meal
                        </td>
                    </tr>
                    <tr>
                        <td align="right" style="height: 18px; width: 446px;" valign="bottom">
                            <asp:Label ID="Label5" runat="server" Text="Number of Kids This Meal:"></asp:Label>
                        </td>
                        <td align="left" style="width: 50%; height: 18px" valign="bottom">
                    ...
                    <tr>
                        <td align="right" style="height: 21px; width: 446px;" valign="bottom">
                            <asp:Label ID="Label21" runat="server" Text="Rounded Production Number This Meal:"></asp:Label>
                        </td>
                ...
                <table width="100%">
                    <tr>
                        <td align="right" colspan="1" style="height: 3px; width: 212px;" valign="bottom">
                            <asp:Label ID="Label2" runat="server" Text="Protein:"></asp:Label>
                        </td>
                        <td align="left" style="height: 3px; width: 687px;" valign="bottom">
                            <asp:DropDownList ID="ProteinDropDownList" runat="server" OnSelectedIndexChanged="ProteinDropDownList_SelectedIndexChanged"
                                AutoPostBack="true" Width="190px">
                            </asp:DropDownList>
                            <asp:Label ID="Label6" runat="server" Text="Serving Size:"></asp:Label>
                            <asp:Label ID="ProteinServingSizeLabel" runat="server" Text="0 " Width="52px"></asp:Label><asp:Label
                                ID="ProteinServingSizeTypeLabel" runat="server" Text="ounce(s)" Width="60px"></asp:Label><asp:Button
                                    ID="ViewProteinYieldDetailButton" runat="server" Text="View/Modify Yield/Notes"
                                    Width="172px" Font-Bold="True" OnClick="ViewProteinYieldDetailButton_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" colspan="1" style="height: 11px; width: 212px;" valign="bottom">
                            <asp:Label ID="Label97" runat="server" Text="Vegetable:"></asp:Label>
                        </td>
                        <td align="left" style="height: 11px; width: 687px;" valign="top">
                            ...
                            <asp:Label ID="VegetableServingSizeLabel" runat="server" Text="0 " Width="52px"></asp:Label><asp:Label
                                ID="VegetableServingSizeTypeLabel" runat="server" Text="ounce(s)" Width="60px"></asp:Label><asp:Button
                                    ID="ViewVegetableYieldDetailButton" runat="server" Text="View/Modify Yield/Notes"
                                    Width="172px" Font-Bold="True" OnClick="ViewVegetableYieldDetailButton_Click" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" style="height: 9px; width: 687px;" valign="top">
                            <asp:DropDownList ID="FruitDropDownList" runat="server" Width="190px" AutoPostBack="True"
                                OnSelectedIndexChanged="FruitDropDownList_SelectedIndexChanged">
                            </asp:DropDownList>
                            <asp:Label ID="Label95" runat="server" Text="Serving Size:"></asp:Label>
                            <asp:Label ID="FruitServingSizeLabel" runat="server" Text="0 " Width="52px"></asp:Label><asp:Label
                                ID="FruitServingSizeTypeLabel" runat="server" Text="ounce(s)" Width="60px"></asp:Label><asp:Button
                                    ID="ViewFruitYieldDetailButton" runat="server" Text="View/Modify Yield/Notes"
                                    Width="172px" Font-Bold="True" OnClick="ViewFruitYieldDetailButton_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" colspan="1" style="height: 11px; width: 212px;" valign="bottom">
                        ...
                        <td align="left" style="height: 11px; width: 687px;" valign="top">
                            ...
                            <asp:Label ID="Other1ServingSizeLabel" runat="server" Text="0 " Width="52px"></asp:Label><asp:Label
                                ID="Other1ServingSizeTypeLabel" runat="server" Text="ounce(s)" Width="60px"></asp:Label><asp:Button
                                    ID="ViewOther1YieldDetailButton" runat="server" Text="View/Modify Yield/Notes"
                                    Width="172px" Font-Bold="True" OnClick="ViewOther1YieldDetailButton_Click" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" valign="top" class="style2">
                            ...
                            <asp:Label ID="Other2ServingSizeLabel" runat="server" Text="0 " Width="52px"></asp:Label><asp:Label
                                ID="Other2ServingSizeTypeLabel" runat="server" Text="ounce(s)" Width="60px"></asp:Label><asp:Button
                                    ID="ViewOther2YieldDetailButton" runat="server" Text="View/Modify Yield/Notes"
                                    Width="172px" Font-Bold="True" OnClick="ViewOther2YieldDetailButton_Click" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left" valign="top" style="width: 687px">
                            ...
                            <asp:Label ID="Other3ServingSizeLabel" runat="server" Text="0 " Width="52px"></asp:Label><asp:Label
                                ID="Other3ServingSizeTypeLabel" runat="server" Text="ounce(s)" Width="60px"></asp:Label><asp:Button
                                    ID="ViewOther3YieldDetailButton" runat="server" Text="View/Modify Yield/Notes"
                                    Width="172px" Font-Bold="True" OnClick="ViewOther3YieldDetailButton_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" colspan="1" style="width: 212px" valign="bottom">
                    ...
                    <tr>
                        <td align="center" colspan="2" style="height: 8px" valign="top">
                            ...
                            <asp:HiddenField ID="ProteinRecipeDetailIDHiddenField" runat="server" />
                            <asp:HiddenField ID="VegetableRecipeDetailIDHiddenField" runat="server" />
                            <asp:HiddenField ID="FruitRecipeDetailIDHiddenField" runat="server" />
                            ...
                            <asp:HiddenField ID="YieldDetailRecipeDetailIDHiddenField" runat="server" />
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
        ...
        <table style="width: 899px">
            <tr>
                <td align="center" style="height: 15px">
                    <asp:Button ID="SaveMealDetailButton" runat="server" Font-Bold="True" Text="Save Meal Details"
                        OnClick="SaveMealDetailButton_Click" Enabled="false" /><asp:Button ID="CancelMealDetailButton"
                            runat="server" Font-Bold="True" Text="Cancel" Width="64px" />
                </td>
            </tr>
        </table>
    </asp:Panel>
                ...
                <table id="Table2" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 50%; height: 21px">
                            ...
                            <asp:Label ID="CookChillServingSizeTypeLabel" runat="server" Text="cup(s)" Width="53px"></asp:Label>
                        </td>
                    </tr>
                    <tr>
            ...
            <tr>
                <td align="center" colspan="2" style="width: 100%; height: 22px">
                    <asp:Button ID="SaveRegularYieldDetailButton" runat="server" Font-Bold="True" OnClick="SaveRegularYieldDetailButton_Click"
                        Text="Save Yield Details" Enabled="false" /><asp:Button ID="CancelRegularYieldDetailButton"
                            runat="server" Font-Bold="True" Text="Cancel" />
                </td>
            </tr>
        </table>
    </asp:Panel>
    ...
    <cc1:ModalPopupExtender ID="CookChillYieldPopupExtender" runat="server" BehaviorID="CookChillYieldPopupBehavior"
        OkControlID="CancelCookChillYieldDetailButton" PopupControlID="CookChillYieldPanel"
        TargetControlID="CookChillYieldPopupButton"   Drag="true" PopupDragHandleControlID="CookChillYieldPanel">
    </cc1:ModalPopupExtender>
    <cc1:ModalPopupExtender ID="RegularYieldPopupExtender" runat="server" BehaviorID="RegularYieldPopupBehavior"
        OkControlID="CancelRegularYieldDetailButton" PopupControlID="RegularYieldPanel"
        TargetControlID="RegularYieldPopupButton"  Drag="true" PopupDragHandleControlID="RegularYieldPanel">
    </cc1:ModalPopupExtender>
    <cc1:ModalPopupExtender BehaviorID="mpeModalPopupBehavior" ID="mpe" runat="server"
        CancelControlID="CancelMealDetailButton" PopupControlID="MenuComponentsPanel"
        BackgroundCssClass="modalBackground" TargetControlID="ClientButton" Drag="true" PopupDragHandleControlID="MenuComponentsPanel">
    </cc1:ModalPopupExtender>
