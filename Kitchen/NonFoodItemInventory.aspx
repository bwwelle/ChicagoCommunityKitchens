<%@ Page Language="VB" EnableEventValidation="false"  Title = "CCK Non-Food Item Inventory" AutoEventWireup="false" MasterPageFile="~/Site.master" CodeFile="NonFoodItemInventory.aspx.vb" Inherits="NonFoodItemInventory" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent"> 
    <div align="left">
        <asp:Label ID="Label1" runat="server" Text="View Non-Food Item"></asp:Label>&nbsp;</div>
        <table style="width: 100%">
            ...
            <tr>
                <td align="right" colspan="13" class="style1">
                    <asp:TextBox ID="NonFoodItemNameSearchTextBox" runat="server" Width="279px"></asp:TextBox>
                </td>
                <td align="left" colspan="13" class="style1">
                    <asp:Button ID="NonFoodItemSearchButton" runat="server" Text="Search" Width="106px" 
                        Font-Bold="True" style="margin-bottom: 0px"/>
                </td>
            </tr>
            <tr>
                <td align="center" colspan="26" style="height: 26px">
                    <asp:Button ID="CreateNewNonFoodItemButton" runat="server" 
                        Text="Create New Non-Food Item" style="font-weight: 700" /></td>
            </tr>
            <tr>
                <td align="center" colspan="26" style="height: 22px">
                    <asp:GridView ID="NonFoodItemGridView" runat="server" OnRowDataBound="NonFoodItemGridView_RowDataBound" OnSelectedIndexChanging="NonFoodItemGridView_SelectedIndexChanging">
