        ...
        <tr>
            ...
            <td align="left" colspan="4" style="height: 17px; width: 50%;" valign="top">
                <asp:DropDownList ID="UnitDropDownList" runat="server" Width="152px">
                    <asp:ListItem>Select Recipe Unit</asp:ListItem>
                    <asp:ListItem>#10 cans</asp:ListItem>
                    <asp:ListItem>#2.5 cans</asp:ListItem>
                    <asp:ListItem>bucket</asp:ListItem>
                    <asp:ListItem>bushel</asp:ListItem>
                    ...
                    <asp:ListItem>ounces (fluid)</asp:ListItem>
                    <asp:ListItem>ounces or pounds</asp:ListItem>
                    <asp:ListItem>ounes (fluid)</asp:ListItem>
