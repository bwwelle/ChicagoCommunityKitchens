<%@ Page Language="VB" EnableEventValidation="false"  Title = "CCK Food Item Inventory" AutoEventWireup="false" MasterPageFile="~/Site.master"  CodeFile="FoodItemInventory.aspx.vb" Inherits="FoodItemInventory" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div align="left">
        <asp:Label ID="Label1" runat="server" Text="View Inventory Item"></asp:Label>&nbsp;</div>
        <table style="width: 100%">
            ...
            <tr>
                <td align="right" colspan="13" class="style1">
                    <asp:TextBox ID="FoodItemNameSearchTextBox" runat="server" Width="279px"></asp:TextBox>
                </td>
                <td align="left" colspan="13" class="style1">
                    <asp:Button ID="FoodItemSearchButton" runat="server" Text="Search" Width="106px" 
                        Font-Bold="True" style="margin-bottom: 0px"/>
                </td>
            </tr>
            <tr>
                <td align="center" colspan="26" style="height: 26px">
                    <asp:Button ID="CreateNewIngredientButton" runat="server" 
                        Text="Create New Inventory Item" style="font-weight: 700" /></td>
            </tr>
            <tr>
                <td align="center" colspan="26" style="height: 22px">
                    <asp:GridView ID="IngredientGridView" runat="server" OnRowDataBound="IngredientGridView_RowDataBound" OnSelectedIndexChanging="IngredientGridView_SelectedIndexChanging">
