<%@ Page Language="C#" AutoEventWireup="true"  Title = "CCK Site Route Order"CodeFile="SiteRouteOrder.aspx.cs" Inherits="SiteRouteOrder"  MasterPageFile="~/Site.master" %>
    ...
    <div>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td align="right" colspan="1" style="width: 10%; height: 21px" valign="top">
                    <ajaxToolkit:ReorderList ID="NorthOrderNumberList" runat="server" CssClass="reorderStyle">
                    </ajaxToolkit:ReorderList>
                </td>
                <td align="left" colspan="2" style="height: 21px; width: 40%;" valign="top">
                    <ajaxToolkit:ReorderList ID="NorthRouteOrderList" runat="server" AllowReorder="true"
                        LayoutType="Table" OnItemReorder="NorthRouteOrderItems_ItemReorder" PostBackOnReorder="true">
                        <ItemTemplate>
                            <span style="cursor: pointer;">
                                <asp:Label ID="ItemName" runat="server" Text='<%# Container.DataItem %>' />
                            </span>
