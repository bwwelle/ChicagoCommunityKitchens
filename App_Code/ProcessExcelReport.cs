...
public class ProcessExcelReport
{
    ...
    public void RenderReport()
    {
        ...
        const string deviceInfo = "<DeviceInfo>" + "<SimplePageHeaders>False</SimplePageHeaders>" + "</DeviceInfo>";
        ...
        {
            scheduleTypeParameter.Name = "ScheduleType";
            scheduleTypeParameter.Values.Add(ScheduleType);
            rview.ServerReport.SetParameters(new ReportParameter[] { scheduleTypeParameter });
        }
        ...
        byte[] bytes = rview.ServerReport.Render("Excel", deviceInfo, out mimeType, out encoding, out extension,
            out streamids, out warnings);

        Response.ContentType = "application/xls";
        Response.AddHeader("Content-disposition", "filename=" + name + ".xls");
